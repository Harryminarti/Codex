...
public class organiser_round2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organiser_round2);
        find_id();
        ...
        round1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(organiser_round2.this,Round1_Score.class));
            }
        });
...
// ------------------------------------------------------------------------------------------------------------------------
    ...
    public void check_user(){
        ...
        if(quest.isEmpty()||opt1.isEmpty()||opt2.isEmpty()||opt3.isEmpty()||opt4.isEmpty()||ans.isEmpty()){
            Toast.makeText(organiser_round2.this,"Please Fill All Options",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        database.push().setValue(qs).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                Toast.makeText(organiser_round2.this,"Question added successfully",Toast.LENGTH_SHORT).show();
                question.setText("");
                option1.setText("");
                option2.setText("");
                option3.setText("");
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(organiser_round2.this,e.toString(),Toast.LENGTH_SHORT).show();
